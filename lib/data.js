...
export const analyticsData = {
  viewsByMonth: [
    { month: "January", views: 1200 },
    { month: "February", views: 900 },
    // ...more months
  ],
  genreDistribution: [
  ...
  ratingDistribution: [
    { rating: "PG-13", count: 40 },
    { rating: "R", count: 20 },
    // ...more ratings
  ],
  topMovies: [
    { title: "Movie A", views: 500 },
    { title: "Movie B", views: 400 },
    // ...more movies
  ],
};

// Object array of movie objects
